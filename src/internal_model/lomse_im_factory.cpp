...
ImoObj* ImFactory::inject(int type, DocModel* pDocModel, ImoId id)
{
    ...
    switch(type)
    {
        ...
        case k_imo_group_layout:        pObj = LOMSE_NEW ImoGroupLayout();        break;
        case k_imo_group_layouts:       pObj = LOMSE_NEW ImoGroupLayouts();       break;
        ...
        case k_imo_layouts:             pObj = LOMSE_NEW ImoLayouts();            break;
        ...
        case k_imo_score_layout:        pObj = LOMSE_NEW ImoScoreLayout();        break;
        case k_imo_score_layouts:       pObj = LOMSE_NEW ImoScoreLayouts();       break;
...
//        case k_imo_slur_data:           pObj = LOMSE_NEW ImoSlurData();           break;
        ...
        case k_imo_system_layout:       pObj = LOMSE_NEW ImoSystemLayout();       break;
...
ImoObj* ImFactory::clone(ImoObj* a)
{
    ...
    switch(a->get_obj_type())
    {
        ...
        case k_imo_group_layout:        pImo = LOMSE_NEW ImoGroupLayout(*(static_cast<ImoGroupLayout*>(a)));                break;
        case k_imo_group_layouts:       pImo = LOMSE_NEW ImoGroupLayouts(*(static_cast<ImoGroupLayouts*>(a)));              break;
        ...
        case k_imo_layouts:             pImo = LOMSE_NEW ImoLayouts(*(static_cast<ImoLayouts*>(a)));                        break;
        ...
        case k_imo_score_layout:        pImo = LOMSE_NEW ImoScoreLayout(*(static_cast<ImoScoreLayout*>(a)));                break;
        case k_imo_score_layouts:       pImo = LOMSE_NEW ImoScoreLayouts(*(static_cast<ImoScoreLayouts*>(a)));              break;
        ...
        case k_imo_system_layout:              pImo = LOMSE_NEW ImoSystemLayout(*(static_cast<ImoSystemLayout*>(a)));                          break;
